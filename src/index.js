...
class ParallaxScrollView extends Component {
  ...
  render() {
    ...
    const maybeStickyHeader = this._maybeRenderStickyHeader({ parallaxHeaderHeight: this.state.parallaxHeaderHeight, stickyHeaderHeight, backgroundColor, renderStickyHeader });
          ...
          React.cloneElement(scrollElement, {
              ...
              style: [styles.scrollView, scrollElement.props.style],
							onScroll: Animated.event(
								[{ nativeEvent: { contentOffset: { y: this.staticState.scrollY } } }],
  ...
  _maybeUpdateScrollPosition(e) {
    ...
    const { scrollY } = this.staticState;
